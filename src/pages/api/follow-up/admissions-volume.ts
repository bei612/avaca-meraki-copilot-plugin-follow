/**
 * Admissions Volume Follow-up API - Pages Router 版本
 */
...
export default async function handler(
  ...
  try {
    ...
    console.log('[follow-up-actions API] 处理招生量跟进请求');
    ...
    const response: FollowUpResponse = {
      data: {
        actionType: 'admissions_volume_follow_up',
        message: '💡 Follow-up:',
    ...
    console.error('[follow-up-actions API] 招生量跟进处理错误:', error);
